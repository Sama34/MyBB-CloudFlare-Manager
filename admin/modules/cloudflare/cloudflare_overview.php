...
if(!$mybb->input['action'])
{
	...
	$table->construct_cell("<a href=\"https://dash.cloudflare.com/{$cache->read('cloudflare_account_id')}/" . htmlspecialchars_uni($mybb->settings['cloudflare_domain']) . "\" target=\"_blank\">View/Modify</a>", array('width' => '25%'));
	$table->construct_row();
